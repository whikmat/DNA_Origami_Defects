...
void render_model(Document &doc) {
    ...
    doc.function("model.structure_energy", &structure_energy<StrandList const &, Model<real64>>);
    doc.function("model.structure_energy", &structure_energy<StrandList const &, Model<real32>>);
}
