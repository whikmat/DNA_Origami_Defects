...
configure_file(${CMAKE_CURRENT_SOURCE_DIR}/package/info.py ${CMAKE_CURRENT_BINARY_DIR}/nupack/info.py)

add_custom_target(copy-python ALL DEPENDS ${link_outputs})
set(NUPACK_PYTHON_OUTPUTS ${link_outputs} CACHE STRING "list of python output files")
